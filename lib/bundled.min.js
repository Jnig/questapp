angular.module("gettext", []), angular.module("gettext").constant("gettext", function(a) {
    return a;
}), angular.module("gettext").factory("gettextCatalog", [ "gettextPlurals", "$http", "$cacheFactory", "$interpolate", "$rootScope", function(a, b, c, d, e) {
    var f, g = function(a) {
        return f.debug && f.currentLanguage !== f.baseLanguage ? "[MISSING]: " + a : a;
    };
    return f = {
        debug: !1,
        strings: {},
        ...
        setCurrentLanguage: function(a) {
            this.currentLanguage = a, e.$broadcast("gettextLanguageChanged");
        },
        setStrings: function(a, b) {
            this.strings[a] || (this.strings[a] = {});
            for (var c in b) {
                var d = b[c];
                this.strings[a][c] = "string" == typeof d ? [ d ] : d;
            }
        },
        getStringForm: function(a, b) {
            var c = this.strings[this.currentLanguage] || {}, d = c[a] || [];
            return d[b];
        },
        getString: function(a, b) {
            return a = this.getStringForm(a, 0) || g(a), b ? d(a)(b) : a;
        },
        getPlural: function(b, c, e, f) {
            var h = a(this.currentLanguage, b);
            return c = this.getStringForm(c, h) || g(1 === b ? c : e), f ? d(c)(f) : c;
        },
        loadRemote: function(a) {
            return b({
                ...
                for (var b in a) f.setStrings(b, a[b]);
            });
        }
    };
} ]), angular.module("gettext").directive("translate", [ "gettextCatalog", "$parse", "$animate", "$compile", function(a, b, c, d) {
    function e(a, b, c) {
    ...
    return {
        ...
        compile: function(g, h) {
            e(!h.translatePlural || h.translateN, "translate-n", "translate-plural"), e(!h.translateN || h.translatePlural, "translate-plural", "translate-n");
            var i = f(g.html()), j = h.translatePlural;
            return {
                post: function(e, f, g) {
                    function h() {
                        var b;
                        j ? (e = l || (l = e.$new()), e.$count = k(e), b = a.getPlural(e.$count, i, j)) : b = a.getString(i);
                        var g = angular.element("<span>" + b + "</span>");
                        d(g.contents())(e);
                        var h = f.contents(), m = g.contents();
                        c.enter(m, f), c.leave(h);
                    }
                    var k = b(g.translateN), l = null;
                    g.translateN && e.$watch(g.translateN, h), e.$on("gettextLanguageChanged", h), h();
                }
            };
        }
    };
    ...
    void 0 === angular.element.prototype.querySelectorAll && (angular.element.prototype.querySelectorAll = function(a) {
        ...
        c.parse = function(c) {
            ...
            var e = a + " in " + (d ? "$items" : b);
            return c && (e += " track by " + c), e;
        };
    } ]).controller("uiSelectCtrl", [ "$scope", "$element", "$timeout", "RepeatParser", "uiSelectMinErr", function(a, b, c, d, e) {
        function f() {
            i.resetSearchInput && (i.search = j, i.selected && i.items.length && (i.activeIndex = i.items.indexOf(i.selected)));
        }
        function g(a) {
            var b = !0;
            switch (a) {
              case m.Down:
                i.activeIndex < i.items.length - 1 && i.activeIndex++;
                break;

              case m.Up:
                i.activeIndex > 0 && i.activeIndex--;
                break;

              case m.Tab:
              case m.Enter:
                i.select(i.items[i.activeIndex]);
                break;
        ...
        function h() {
            var a = b.querySelectorAll(".ui-select-choices-content"), c = a.querySelectorAll(".ui-select-choices-row");
            if (c.length < 1) throw e("choices", "Expected multiple .ui-select-choices-row but got '{0}'.", c.length);
            var d = c[i.activeIndex], f = d.offsetTop + d.clientHeight - a[0].scrollTop, g = a[0].offsetHeight;
            f > g ? a[0].scrollTop += f - g : f < d.clientHeight && (i.isGrouped && 0 === i.activeIndex ? a[0].scrollTop = 0 : a[0].scrollTop -= d.clientHeight - f);
        }
        var i = this, j = "";
        i.placeholder = void 0, i.search = j, i.activeIndex = 0, i.items = [], i.selected = void 0, 
        i.open = !1, i.focus = !1, i.focusser = void 0, i.disabled = void 0, i.resetSearchInput = void 0, 
        i.refreshDelay = void 0, i.isEmpty = function() {
            return angular.isUndefined(i.selected) || null === i.selected || "" === i.selected;
        };
        var k = b.querySelectorAll("input.ui-select-search");
        if (1 !== k.length) throw e("searchInput", "Expected 1 input.ui-select-search but got '{0}'.", k.length);
        i.activate = function(a) {
            i.disabled || (f(), i.open = !0, c(function() {
                i.search = a || i.search, k[0].focus();
            }));
        }, i.parseRepeatAttr = function(b, c) {
            function f(b) {
                i.groups = {}, angular.forEach(b, function(b) {
                    var d = a.$eval(c), e = angular.isFunction(d) ? d(b) : b[d];
                    i.groups[e] ? i.groups[e].push(b) : i.groups[e] = [ b ];
                }), i.items = [], angular.forEach(Object.keys(i.groups).sort(), function(a) {
                    i.items = i.items.concat(i.groups[a]);
                });
            }
            function g(a) {
                i.items = a;
            ...
            var h = c ? f : g;
            i.parserResult = d.parse(b), i.isGrouped = !!c, i.itemProperty = i.parserResult.itemName, 
            a.$watchCollection(i.parserResult.source, function(a) {
                if (void 0 === a || null === a) i.items = []; else {
                    if (!angular.isArray(a)) throw e("items", "Expected an array but got '{0}'.", a);
                    h(a), i.ngModel.$modelValue = null;
                }
            });
        };
        var l;
        i.refresh = function(b) {
            void 0 !== b && (l && c.cancel(l), l = c(function() {
                a.$eval(b);
            }, i.refreshDelay));
        }, i.setActiveItem = function(a) {
            i.activeIndex = i.items.indexOf(a);
        }, i.isActive = function(a) {
            return i.items.indexOf(a[i.itemProperty]) === i.activeIndex;
        }, i.select = function(b) {
            var c = {};
            c[i.parserResult.itemName] = b, i.onSelectCallback(a, {
                $item: b,
                $model: i.parserResult.modelMapper(a, c)
            }), i.selected = b, i.close();
        }, i.close = function() {
            i.open && (f(), i.open = !1, c(function() {
                i.focusser[0].focus();
            }, 0, !1));
        };
        var m = {
        ...
        k.on("keydown", function(b) {
            if (i.items && i.items.length >= 0) {
                var c = b.which;
                switch (a.$apply(function() {
                    var a = g(c);
                    a && c != m.Tab && (b.preventDefault(), b.stopPropagation());
                }), c) {
                  case m.Down:
                  case m.Up:
                    h();
    ...
    } ]).directive("uiSelect", [ "$document", "uiSelectConfig", "uiSelectMinErr", "$compile", "$parse", function(a, b, c, d, e) {
        return {
            restrict: "EA",
            templateUrl: function(a, c) {
                var d = c.theme || b.theme;
                return d + "/select.tpl.html";
            },
            replace: !0,
            transclude: !0,
            ...
            controllerAs: "$select",
            link: function(b, f, g, h, i) {
                function j(a) {
                    var c = !1;
                    c = window.jQuery ? window.jQuery.contains(f[0], a.target) : f[0].contains(a.target), 
                    c || (k.close(), b.$digest());
                }
                var k = h[0], l = h[1];
                k.onSelectCallback = e(g.onSelect), l.$parsers.unshift(function(a) {
                    var c = {};
                    c[k.parserResult.itemName] = a;
                    var d = k.parserResult.modelMapper(b, c);
                    return d;
                }), l.$formatters.unshift(function(a) {
                    var c = k.parserResult.source(b);
                    if (c) for (var d = c.length - 1; d >= 0; d--) {
                        var e = {};
                        e[k.parserResult.itemName] = c[d];
                        var f = k.parserResult.modelMapper(b, e);
                        if (f == a) return c[d];
                    }
                    return a;
                }), k.ngModel = l;
                var m = angular.element("<input ng-disabled='$select.disabled' class='ui-select-focusser ui-select-offscreen' type='text' aria-haspopup='true' role='button' />");
                d(m)(b), k.focusser = m, f.append(m), m.bind("focus", function() {
                    ...
                    return a.which === n.BACKSPACE ? (a.preventDefault(), a.stopPropagation(), k.select(void 0), 
                    void b.$digest()) : void (a.which === n.TAB || n.isControl(a) || n.isFunctionKey(a) || a.which === n.ESC || ((a.which == n.DOWN || a.which == n.UP || a.which == n.ENTER || a.which == n.SPACE) && (a.preventDefault(), 
                    a.stopPropagation(), k.activate()), b.$digest()));
                }), m.bind("keyup input", function(a) {
                    a.which === n.TAB || n.isControl(a) || n.isFunctionKey(a) || a.which === n.ESC || a.which == n.ENTER || a.which === n.BACKSPACE || (k.activate(m.val()), 
                    m.val(""), b.$digest());
                });
                var n = {
                    TAB: 9,
                ...
                g.$observe("disabled", function() {
                    k.disabled = void 0 !== g.disabled ? g.disabled : !1;
                }), g.$observe("resetSearchInput", function() {
                    var a = b.$eval(g.resetSearchInput);
                    k.resetSearchInput = void 0 !== a ? a : !0;
                }), b.$watch("$select.selected", function(a) {
                    l.$viewValue !== a && l.$setViewValue(a);
                }), l.$render = function() {
                    k.selected = l.$viewValue;
                }, a.on("click", j), b.$on("$destroy", function() {
                    a.off("click", j);
                }), i(b, function(a) {
                    var b = angular.element("<div>").append(a), d = b.querySelectorAll(".ui-select-match");
                    if (d.removeAttr("ui-select-match"), 1 !== d.length) throw c("transcluded", "Expected 1 .ui-select-match but got '{0}'.", d.length);
                    f.querySelectorAll(".ui-select-match").replaceWith(d);
                    var e = b.querySelectorAll(".ui-select-choices");
                    if (e.removeAttr("ui-select-choices"), 1 !== e.length) throw c("transcluded", "Expected 1 .ui-select-choices but got '{0}'.", e.length);
                    f.querySelectorAll(".ui-select-choices").replaceWith(e);
                });
            }
        };
        ...
        return {
            ...
            compile: function(e, f) {
                ...
                return function(e, f, g, h, i) {
                    var j = g.groupBy;
                    if (h.parseRepeatAttr(g.repeat, j), j) {
                    ...
                    i(function(a) {
                        var b = f.querySelectorAll(".ui-select-choices-row-inner");
                        if (1 !== b.length) throw c("rows", "Expected 1 .ui-select-choices-row-inner but got '{0}'.", b.length);
                        b.append(a), d(f)(e);
                    }), e.$watch("$select.search", function() {
                        h.activeIndex = 0, h.refresh(g.refresh);
    ...
    a.put("bootstrap/match.tpl.html", '<button type="button" class="btn btn-default form-control ui-select-match" tabindex="-1" ng-hide="$select.open" ng-disabled="$select.disabled" ng-class="{\'btn-default-focus\':$select.focus}" ;="" ng-click="$select.activate()"><span ng-show="$select.isEmpty()" class="text-muted">{{$select.placeholder}}</span> <span ng-hide="$select.isEmpty()" ng-transclude=""></span> <span class="caret"></span></button>'), 
    ...
    a.put("select2/match.tpl.html", '<a class="select2-choice ui-select-match" ng-class="{\'select2-default\': $select.isEmpty()}" ng-click="$select.activate()"><span ng-show="$select.isEmpty()" class="select2-chosen">{{$select.placeholder}}</span> <span ng-hide="$select.isEmpty()" class="select2-chosen" ng-transclude=""></span> <span class="select2-arrow"><b></b></span></a>'), 
...
webStorageModule.constant("defaultSettings", {
...
}), webStorageModule.factory("webStorage", [ "$rootScope", "defaultSettings", function(a, b) {
    "use strict";
    function c(a, b) {
        if (v) {
            try {
                localStorage.setItem(y + a, JSON.stringify(b));
            } catch (c) {
                return t(c);
            }
            return !0;
    ...
    function d(a, b) {
        if (w) {
            try {
                sessionStorage.setItem(y + a, JSON.stringify(b));
            } catch (c) {
                return t(c);
            }
            return !0;
    ...
    function f(a) {
        if (v) try {
            var b = localStorage.getItem(y + a);
    ...
    function g(a) {
        if (w) try {
            var b = sessionStorage.getItem(y + a);
            return b && JSON.parse(b);
        } catch (c) {
            return t(c), null;
        }
    ...
    function o() {
        ...
        if (y) {
            var a = y.length;
            try {
                for (var b in localStorage) b.substr(0, a) === y && localStorage.removeItem(b);
            } catch (c) {
                return t(c);
            }
            return !0;
    ...
    function p() {
        ...
        if (y) {
            var a = y.length;
            try {
                for (var b in sessionStorage) b.substr(0, a) === y && sessionStorage.removeItem(b);
            } catch (c) {
                return t(c);
            }
            return !0;
    ...
    function r() {
        try {
            return localStorage.setItem(y + "angular.webStorage.test", !0), localStorage.removeItem(y + "angular.webStorage.test"), 
            !0;
        } catch (a) {
            return !1;
        }
    ...
    function s() {
        try {
            return sessionStorage.setItem(y + "angular.webStorage.test", !0), sessionStorage.removeItem(y + "angular.webStorage.test"), 
            !0;
        } catch (a) {
            return !1;
        }
    ...
    function t(b) {
        return a.$broadcast(u, b.title + ": " + b.message), !1;
    }
    var u = b.errorName, v = r(), w = s(), x = b.order, y = b.prefix, z = {}, A = {
        isSupported: v || w,
        local: {
            isSupported: v,
            add: c,
    ...
    return A.add = function(a, b, c) {
        c = "undefined" != typeof c ? !!c : !1;
        for (var d = !1, e = x.length, f = 0; e > f; ++f) {
            var g = A[x[f]];
            if (g.isSupported && (d = g.add(a, b) || d, !c)) return d;
        }
        return d;
    }, A.get = function(a, b) {
        b = "undefined" != typeof b ? !!b : !0;
        for (var c = x.length, d = 0; c > d; ++d) {
            var e = A[x[d]];
            if (e.isSupported) {
                var f = e.get(a);
                if (!b || null !== f) return f;
            }
        }
        return null;
    }, A.has = function(a, b) {
        return null !== A.get(a, b);
    }, A.remove = function(a, b) {
        b = "undefined" != typeof b ? !!b : !0;
        for (var c = !1, d = x.length, e = 0; d > e; ++e) {
            var f = A[x[e]];
            if (f.isSupported && (c = f.remove(a) || c, !b)) return c;
        }
        return c;
    }, A.clear = function(a) {
        a = "undefined" != typeof a ? !!a : !0;
        for (var b = !1, c = x.length, d = 0; c > d; ++d) {
            var e = A[x[d]];
            if (e.isSupported && (b = e.clear() || b, !a)) return b;
        }
        return b;
    }, A.errorName = function(a) {
        var b = u;
        ...
        if ("undefined" != typeof a) {
            x = [];
            for (var c in a) /^(local|session|memory)$/.test(a[c]) && x.push(a[c]);
        }
        return b;
    }, A.prefix = function(a) {
        var b = y;
...
try {
    window.localStorage || (window.localStorage = {
        getItem: function(a) {
            return a && this.hasOwnProperty(a) ? unescape(document.cookie.replace(new RegExp("(?:^|.*;\\s*)" + escape(a).replace(/[\-\.\+\*]/g, "\\$&") + "\\s*\\=\\s*((?:[^;](?!;))*[^;]?).*"), "$1")) : null;
        },
        key: function(a) {
            return unescape(document.cookie.replace(/\s*\=(?:.(?!;))*$/, "").split(/\s*\=(?:[^;](?!;))*[^;]?;\s*/)[a]);
        },
        ...
        removeItem: function(a) {
            a && this.hasOwnProperty(a) && (document.cookie = escape(a) + "=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/", 
            this.length--);
        },
    ...
    window.sessionStorage || (window.sessionStorage = {
        ...
        setItem: function(a, b) {
            a && (document.cookie = escape(a) + "=" + escape(b) + "; path=/", this.length = document.cookie.match(/\=/g).length);
        },
        length: 0,
        removeItem: function(a) {
            a && this.hasOwnProperty(a) && (document.cookie = escape(a) + "=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/", 
...
!function(a, b) {
    var c = function() {
        function c(a) {
            var b = {};
            for (var c in w) {
                var d = a.match(w[c]), e = (d ? d.length : 0) / a.length;
                b[c] = e;
            }
            return b;
        }
        function d(a, d) {
            var f = c(a);
            if (f["Hangul Syllables"] + f["Hangul Jamo"] + f["Hangul Compatibility Jamo"] >= .4) return void d.apply(b, [ "ko" ]);
            if (f["Greek and Coptic"] >= .4) return void d.apply(b, [ "el" ]);
            if (f.Hiragana + f.Katakana + f["Katakana Phonetic Extensions"] >= .2) return void d.apply(b, [ "ja" ]);
            if (f["CJK Unified Ideographs"] + f.Bopomofo + f["Bopomofo Extended"] + f["KangXi Radicals"] >= .4) return void d.apply(b, [ "zh" ]);
            if (f.Cyrillic >= .4) return void e(a, s, d);
            if (f.Arabic + f["Arabic Presentation Forms-A"] + f["Arabic Presentation Forms-B"] >= .4) return void e(a, t, d);
            if (f.Devanagari >= .4) return void e(a, u, d);
            for (var g = 0, h = n.length; h > g; g++) if (f[n[g][0]] >= .4) return void d.apply(b, [ n[g][1] ]);
            return f["Latin-1 Supplement"] + f["Latin Extended-A"] + f["IPA Extensions"] >= .4 ? void e(a, q, function(c) {
                "pt" == c ? e(a, v, d) : d.apply(b, [ c ]);
            }) : f["Basic Latin"] >= .15 ? void e(a, r, d) : void d.apply(b, [ o ]);
        }
        function e(a, c, d) {
            if (a.length < j) return void d.apply(b, [ o ]);
            for (var e = {}, i = f(a), k = 0, l = c.length; l > k; k++) {
                var m = c[k].toLowerCase(), n = h[m] || null;
                n && (e[m] = g(i, n));
            }
            var p = [];
            for (var q in e) p.push([ q, e[q] ]);
            if (0 == p.length) return void d.apply(b, [ o ]);
            var r = p.sort(function(a, b) {
                return a[1] - b[1];
            });
            d.apply(b, [ r[0][0] ]);
        }
        function f(a) {
            for (var b = {}, c = [], a = a.toLowerCase(), d = a.split(""), e = 0, f = d.length - 2; f > e; e++) {
                var g = d[e] + d[e + 1] + d[e + 2] + "";
                b[g] ? b[g] += 1 : b[g] = 1;
            }
            for (var e in b) c[c.length] = [ e, b[e] ];
            return c.sort(function(a, b) {
                return b[1] - a[1];
            });
        }
        function g(a, b) {
            for (var c = 0, d = 0, e = a.length; e > d; d++) c += b[a[d][0]] ? Math.abs(a[d][1] - b[a[d][0]]) : k;
            return c;
        }
        var h = a._languageData || {};
        "object" == typeof module && module.exports === a && (h = require("./_languageData") || {});
        var i = 4096, j = 20, k = 300, l = {
            ab: "Abkhazian",
            af: "Afrikaans",
            ar: "Arabic",
            az: "Azeri",
        ...
        return {
            detect: function(a, c) {
                return a ? (a = a.substr(0, i).replace(/[\u0021-\u0040]/g, ""), void d(a, c)) : void c.apply(b, [ o ]);
            },
            info: function(a, c) {
                this.detect(a, function(a) {
                    return a === o ? void c.apply(b, [ [ o, o, o ] ]) : void c.apply(b, [ [ a, m[a], l[a] ] ]);
                });
            },
            code: function(a, c) {
                this.detect(a, function(a) {
                    return a === o ? void c.apply(b, [ -1 ]) : void c.apply(b, [ m[a] ]);
                });
            },
            name: function(a, c) {
                this.detect(a, function(a) {
                    return a === o ? void c.apply(b, [ o ]) : void c.apply(b, [ l[a] ]);
                });
            }
        };
    };
    a.guessLanguage = (a.module || {}).exports = new c();
}(this), function(a) {
    var b = {
        af: {
            "ie ": 0,
    ...
    a._languageData = ("object" == typeof module && module.exports === a && module || {}).exports = b;
}(this), function(a) {
    var b = function() {
        "use strict";
        var a = "s", c = function(a) {
            ...
            var b = a.getMonth() > 7, d = b ? f(a.getFullYear()) : e(a.getFullYear()), g = c(a), h = 0 > d, i = d - g;
            return h || b ? 0 !== i : 0 > i;
        }, h = function() {
            var b = e(), c = f(), d = b - c;
            ...
            var b = new Date(2010, 6, 15, 1, 0, 0, 0), c = {
    ...
    b.TimeZone = function(a) {
        ...
        var c = {
            ...
            for (var a = c[d], e = a.length, f = 0, g = a[0]; e > f; f += 1) if (g = a[f], b.date_is_dst(b.dst_start_for(g))) return void (d = g);
        }, f = function() {
    ...
    function k(a) {
        var b = a.cache;
        b && k(b), a.array = a.cache = a.criteria = a.object = a.number = a.string = a.value = null, 
        p.length < t && p.push(a);
    }
    function l(a, b, c) {
    ...
    function m(c) {
        ...
        function V(a, b, c, d, e) {
            ...
            b ? (d.push(a), e.push(f), (m ? Yb : he)(a, function(a, g) {
                f[g] = V(a, b, c, d, e);
            }), n && (j(d), j(e)), f) : f;
        }
        function X(a) {
        ...
        function Y(a, b, c) {
            ...
            if ("undefined" == typeof d && (Xd.funcNames && (d = !a.name), d = d || !Xd.funcDecomp, 
            !d)) {
                var e = Fd.call(a);
        ...
        function cb(a, b, c, d, e) {
            (Zd(b) ? Yb : he)(b, function(b, f) {
                ...
                if (b && ((h = Zd(b)) || ie(b))) {
                    ...
                    if (!g) {
                        var l;
                        c && (i = c(j, b), (l = "undefined" != typeof i) && (j = i)), l || (j = h ? Zd(j) ? j : [] : ie(j) ? j : {}), 
                        d.push(b), e.push(j), l || cb(j, b, c, d, e);
                    }
        ...
        function gb(a, b, c, d, e, f) {
            ...
            if (m && m !== !0) return m = l(m), m[2] && (m[2] = l(m[2])), m[3] && (m[3] = l(m[3])), 
            !g || 1 & m[1] || (m[4] = e), !g && 1 & m[1] && (b |= 8), !i || 4 & m[1] || (m[5] = f), 
            j && Id.apply(m[2] || (m[2] = []), c), k && Ld.apply(m[3] || (m[3] = []), d), m[1] |= b, 
            gb.apply(null, m);
            var n = 1 == b || 17 === b ? t : Z;
        ...
        function _b(a, b, c) {
            var d = -1, e = a ? a.length : 0;
            if (b = o.createCallback(b, c, 3), "number" == typeof e) for (var f = nd(e); ++d < e; ) f[d] = b(a[d], d, a); else f = [], 
            he(a, function(a, c, e) {
                f[++d] = b(a, c, e);
            });
            return f;
        ...
        function wc(a) {
            for (var b = arguments, c = 0, d = b.length, e = a ? a.length : 0; ++c < d; ) for (var f = -1, g = b[c]; ++f < e; ) a[f] === g && (Kd.call(a, f--, 1), 
            e--);
            return a;
        }
        function xc(a, b, c) {
            a = +a || 0, c = "number" == typeof c ? c : +c || 1, null == b && (b = a, a = 0);
            for (var d = -1, e = Sd(0, Cd((b - a) / (c || 1))), f = nd(e); ++d < e; ) f[d] = a, 
            a += c;
            return f;
        }
        function yc(a, b, c) {
        ...
        function Cc(a, b, c, d) {
            return "boolean" != typeof b && null != b && (d = c, c = "function" != typeof b && d && d[b] === a ? null : b, 
            b = !1), null != c && (c = o.createCallback(c, d, 3)), eb(a, b, c);
        }
        function Dc(a) {
        ...
        function Nc(a, b, c) {
            ...
            return function() {
                ...
                return r && i ? i = Dd(i) : i || b === l || (i = Jd(p, b)), c && (r = !0, f = a.apply(h, d)), 
                !r || i || e || (d = h = null), f;
            };
        }
        function Oc(a) {
        ...
        function Uc(a, b, c) {
            ...
            S.leading = d, S.maxWait = b, S.trailing = e, Nc(a, b, S);
        }
        function Vc(a, b) {
            return gb(b, 16, [ a ]);
        }
        ...
        function cd(a, b, c) {
            ...
            if (null == c && ("boolean" == typeof a && e ? (c = a, a = 1) : e || "boolean" != typeof b || (c = b, 
            e = !0)), d && e && (b = 1), a = +a || 0, e ? (b = a, a = 0) : b = +b || 0, c || a % 1 || b % 1) {
                var f = Vd();
        ...
        Wd[J] = nd, Wd[K] = od, Wd[L] = pd, Wd[M] = qd, Wd[O] = td, Wd[N] = sd, Wd[P] = ud, 
        Wd[Q] = vd, p.prototype = o.prototype;
        var Xd = o.support = {};
        Xd.funcDecomp = !jb(c.WinRTError) && E.test(m), Xd.funcNames = "string" == typeof qd.name, 
        o.templateSettings = {
            escape: /<%-([\s\S]+?)%>/g,
            evaluate: /<%([\s\S]+?)%>/g,
            interpolate: B,
        ...
        var Yd = Md ? function(a, b) {
            ...
            for (;++h < i; ) if (e = g[h], e && U[typeof e]) for (var k = -1, l = U[typeof e] && _d(e), m = l ? l.length : 0; ++k < m; ) d = l[k], 
            f[d] = j ? j(f[d], e[d]) : e[d];
            return f;
        }, fe = function(a, b, c) {
            var d, e = a, f = e;
            if (!e) return f;
            for (var g = arguments, h = 0, i = "number" == typeof c ? 2 : g.length; ++h < i; ) if (e = g[h], 
            e && U[typeof e]) for (var j = -1, k = U[typeof e] && _d(e), l = k ? k.length : 0; ++j < l; ) d = k[j], 
            ...
            if (!U[typeof e]) return f;
            b = b && "undefined" == typeof c ? b : Y(b, c, 3);
            for (var g = -1, h = U[typeof e] && _d(e), i = h ? h.length : 0; ++g < i; ) if (d = h[g], 
            b(e[d], d, a) === !1) return f;
            return f;
        }, ie = Gd ? function(a) {
        ...
        return o.after = Hc, o.assign = ee, o.at = Sb, o.bind = Ic, o.bindAll = Jc, o.bindKey = Kc, 
        o.chain = id, o.compact = lc, o.compose = Lc, o.constant = Wc, o.countBy = je, o.create = pb, 
        o.createCallback = Xc, o.curry = Mc, o.debounce = Nc, o.defaults = fe, o.defer = Oc, 
        o.delay = Pc, o.difference = mc, o.filter = Vb, o.flatten = qc, o.forEach = Yb, 
        o.forEachRight = Zb, o.forIn = ge, o.forInRight = sb, o.forOwn = he, o.forOwnRight = tb, 
        o.functions = ub, o.groupBy = ke, o.indexBy = le, o.initial = sc, o.intersection = tc, 
        o.invert = wb, o.invoke = $b, o.keys = _d, o.map = _b, o.mapValues = Lb, o.max = ac, 
        o.memoize = Qc, o.merge = Mb, o.min = bc, o.omit = Nb, o.once = Rc, o.pairs = Ob, 
        o.partial = Sc, o.partialRight = Tc, o.pick = Pb, o.pluck = me, o.property = bd, 
        o.pull = wc, o.range = xc, o.reject = ec, o.remove = yc, o.rest = zc, o.shuffle = gc, 
        o.sortBy = jc, o.tap = jd, o.throttle = Uc, o.times = fd, o.toArray = kc, o.transform = Qb, 
        o.union = Bc, o.uniq = Cc, o.values = Rb, o.where = ne, o.without = Dc, o.wrap = Vc, 
        o.xor = Ec, o.zip = Fc, o.zipObject = Gc, o.collect = _b, o.drop = zc, o.each = Yb, 
        o.eachRight = Zb, o.extend = ee, o.methods = ub, o.object = Gc, o.select = Vb, o.tail = zc, 
        o.unique = Cc, o.unzip = Fc, $c(o), o.clone = nb, o.cloneDeep = ob, o.contains = Tb, 
        o.escape = Yc, o.every = Ub, o.find = Wb, o.findIndex = nc, o.findKey = qb, o.findLast = Xb, 
        o.findLastIndex = oc, o.findLastKey = rb, o.has = vb, o.identity = Zc, o.indexOf = rc, 
        o.isArguments = mb, o.isArray = Zd, o.isBoolean = xb, o.isDate = yb, o.isElement = zb, 
        o.isEmpty = Ab, o.isEqual = Bb, o.isFinite = Cb, o.isFunction = Db, o.isNaN = Fb, 
        o.isNull = Gb, o.isNumber = Hb, o.isObject = Eb, o.isPlainObject = ie, o.isRegExp = Ib, 
        o.isString = Jb, o.isUndefined = Kb, o.lastIndexOf = vc, o.mixin = $c, o.noConflict = _c, 
        o.noop = ad, o.now = oe, o.parseInt = pe, o.random = cd, o.reduce = cc, o.reduceRight = dc, 
        o.result = dd, o.runInContext = m, o.size = hc, o.some = ic, o.sortedIndex = Ac, 
        o.template = ed, o.unescape = gd, o.uniqueId = hd, o.all = Ub, o.any = ic, o.detect = Wb, 
        o.findWhere = Wb, o.foldl = cc, o.foldr = dc, o.include = Tb, o.inject = cc, $c(function() {
            var a = {};
        ...
        }), o.VERSION = "2.4.1", o.prototype.chain = kd, o.prototype.toString = ld, o.prototype.value = md, 
        o.prototype.valueOf = md, Yb([ "join", "pop", "shift" ], function(a) {
            var b = xd[a];
    ...
    a.provider("Restangular", function() {
        ...
        a.init = function(a, b) {
            ...
            }, a.setResponseInterceptor = a.addResponseInterceptor, a.setResponseExtractor = a.addResponseInterceptor, 
            b.requestInterceptors = b.requestInterceptors || [], b.defaultInterceptor = function(a, b, c, d, e, f, g) {
                return {
                    element: a,
                    headers: e,
                    params: f,
            ...
            }, b.transformLocalElements = _.isUndefined(b.transformLocalElements) ? !1 : b.transformLocalElements, 
            ...
            f.prototype.setConfig = function(a) {
                ...
                return this.config.suffix && -1 === m.indexOf(this.config.suffix, m.length - this.config.suffix.length) && !this.config.getUrlFromElem(a) && (m += this.config.suffix), 
                a[this.config.restangularFields.httpConfig] = void 0, c(this.config, d, m, {
            ...
            g.prototype = new f(), g.prototype.base = function(a) {
                ...
                return _.reduce(this.parentsArray(a), function(a, d) {
                    ...
                    if (f) {
                        ...
                        b.isValidId(h) && !d.singleOne && (e += "/" + (c.config.encodeIds ? encodeURIComponent(h) : h));
                    }
                    return a.replace(/\/$/, "") + "/" + e;
                }, this.config.baseUrl);
        ...
        a.init(this, b), this.$get = [ "$http", "$q", function(c, d) {
            function e(b) {
                function f(a, c, d, e, f) {
                    if (c[b.restangularFields.route] = d, c[b.restangularFields.getRestangularUrl] = _.bind(P.fetchUrl, P, c), 
                    c[b.restangularFields.getRequestedUrl] = _.bind(P.fetchRequestedUrl, P, c), c[b.restangularFields.addRestangularMethod] = _.bind(L, c), 
                    c[b.restangularFields.clone] = _.bind(r, c, c), c[b.restangularFields.reqParams] = _.isEmpty(e) ? null : e, 
                    c[b.restangularFields.withHttpConfig] = _.bind(z, c), c[b.restangularFields.plain] = _.bind(p, c, c), 
                    c[b.restangularFields.one] = _.bind(g, c, c), c[b.restangularFields.all] = _.bind(h, c, c), 
                    c[b.restangularFields.several] = _.bind(i, c, c), c[b.restangularFields.oneUrl] = _.bind(j, c, c), 
                    c[b.restangularFields.allUrl] = _.bind(k, c, c), c[b.restangularFields.fromServer] = !!f, 
                ...
                function g(a, c, d, e) {
                    ...
                    var g = {};
                    return b.setIdToElem(g, d), b.setFieldToElem(b.restangularFields.singleOne, g, e), 
                    s(a, g, c, !1);
                }
                function h(a, b) {
                    return t(a, [], b, !1);
                ...
                function l(a, c, d) {
                    return a.call = _.bind(m, a), a.get = _.bind(n, a), a[b.restangularFields.restangularCollection] = c, 
                    c && (a.push = _.bind(m, a, "push")), a.$object = d, a;
                }
                function m(a) {
                ...
                function s(a, c, d, e, g, h) {
                    ...
                    return b.useCannonicalId && (j[b.restangularFields.cannonicalId] = b.getIdFromElem(j)), 
                    g && (j[b.restangularFields.getParentList] = function() {
                        return g;
                    }), j[b.restangularFields.restangularCollection] = !1, j[b.restangularFields.get] = _.bind(C, j), 
                    j[b.restangularFields.getList] = _.bind(y, j), j[b.restangularFields.put] = _.bind(E, j), 
                    j[b.restangularFields.post] = _.bind(F, j), j[b.restangularFields.remove] = _.bind(D, j), 
                    j[b.restangularFields.head] = _.bind(G, j), j[b.restangularFields.trace] = _.bind(H, j), 
                    j[b.restangularFields.options] = _.bind(I, j), j[b.restangularFields.patch] = _.bind(J, j), 
                    j[b.restangularFields.save] = _.bind(A, j), q(j), b.transformElem(j, !1, d, O, !0);
                }
                function t(a, c, d, e, g) {
                    var h = b.onBeforeElemRestangularized(c, !0, d), i = f(a, h, d, g, e);
                    return i[b.restangularFields.restangularCollection] = !0, i[b.restangularFields.post] = _.bind(F, i, null), 
                    i[b.restangularFields.remove] = _.bind(D, i), i[b.restangularFields.head] = _.bind(G, i), 
                    i[b.restangularFields.trace] = _.bind(H, i), i[b.restangularFields.putElement] = _.bind(w, i), 
                    i[b.restangularFields.options] = _.bind(I, i), i[b.restangularFields.patch] = _.bind(J, i), 
                    i[b.restangularFields.get] = _.bind(v, i), i[b.restangularFields.getList] = _.bind(y, i, null), 
                    q(i), b.transformElem(i, !0, d, O, !0);
                }
                function u(a, b, c) {
                    var d = t(a, b, c, !1);
                ...
                function B(a, e, f, g, h) {
                    ...
                    var v = function(c) {
                        ...
                        g ? "post" !== a || i[b.restangularFields.restangularCollection] ? (data = s(i[b.restangularFields.parentResource], g, i[b.restangularFields.route], !0, null, f), 
                        data[b.restangularFields.singleOne] = i[b.restangularFields.singleOne], o(j, c, data, u)) : o(j, c, s(i, g, e, !0, null, f), u) : o(j, c, void 0, u);
                    }, w = function(c) {
                    ...
                    })) : b.jsonp && "get" === y && (y = "jsonp"), b.isSafe(a) ? A ? P.resource(this, c, t.httpConfig, z, t.params, e, r, y)[y]({}).then(v, w) : P.resource(this, c, t.httpConfig, z, t.params, e, r, y)[y]().then(v, w) : P.resource(this, c, t.httpConfig, z, t.params, e, r, y)[y](t.element).then(v, w), 
                    l(j.promise, !1, u);
                }
                function C(a, b) {
                ...
                function N(a, b) {
                    var c = {}, d = (b || O).all(a);
                    return c.one = _.bind(g, b || O, b, a), c.post = _.bind(d.post, d), c.getList = _.bind(d.getList, d), 
                    c;
                }
                var O = {}, P = new b.urlCreatorFactory[b.urlCreator]();
                return P.setConfig(b), a.init(O, b), O.copy = _.bind(r, O), O.service = _.bind(N, O), 
                O.withConfig = _.bind(M, O), O.one = _.bind(g, O, null), O.all = _.bind(h, O, null), 
                O.several = _.bind(i, O, null), O.oneUrl = _.bind(j, O, null), O.allUrl = _.bind(k, O, null), 
                O.stripRestangular = _.bind(p, O), O.restangularizeElement = _.bind(s, O), O.restangularizeCollection = _.bind(u, O), 
                O;
            }
            return e(b);
        } ];
    ...
    a.fn.vectorMap = function(a) {
        ...
        if ("addMap" === a) jvm.WorldMap.maps[arguments[1]] = arguments[2]; else {
            ...
            a = a || {}, a.container = this, c = new jvm.WorldMap(a);
        }
        return this;
    };
}(jQuery), function(a) {
...
var jvm = {
    ...
    min: function(a) {
        ...
        if (a instanceof Array) for (b = 0; b < a.length; b++) a[b] < c && (c = a[b]); else for (b in a) a[b] < c && (c = a[b]);
        return c;
    },
    max: function(a) {
...
jvm.$ = jQuery, jvm.AbstractElement = function(a, b) {
    this.node = this.createElement(a), this.name = a, this.properties = {}, b && this.set(b);
}, jvm.AbstractElement.prototype.set = function(a, b) {
    var c;
    if ("object" == typeof a) for (c in a) this.properties[c] = a[c], this.applyAttr(c, a[c]); else this.properties[a] = b, 
    this.applyAttr(a, b);
    ...
    this.container = a, this.setSize(b, c), this.rootElement = new jvm[this.classPrefix + "GroupElement"](), 
    ...
    return a ? a.node.appendChild(b.node) : this.node.appendChild(b.node), b.canvas = this, 
    b;
}, jvm.AbstractShapeElement = function(a, b, c) {
    this.style = c || {}, this.style.current = {}, this.isHovered = !1, this.isSelected = !1, 
    this.updateStyle();
    ...
    var a = {};
    jvm.AbstractShapeElement.mergeStyles(a, this.style.initial), jvm.AbstractShapeElement.mergeStyles(a, this.style.current), 
    this.isHovered && jvm.AbstractShapeElement.mergeStyles(a, this.style.hover), this.isSelected && (jvm.AbstractShapeElement.mergeStyles(a, this.style.selected), 
    this.isHovered && jvm.AbstractShapeElement.mergeStyles(a, this.style.selectedHover)), 
    this.set(a);
...
jvm.VMLCanvasElement.prototype.setSize = function(a, b) {
    var c, d, e, f;
    if (this.width = a, this.height = b, this.node.style.width = a + "px", this.node.style.height = b + "px", 
    this.node.coordsize = a + " " + b, this.node.coordorigin = "0 0", this.rootElement) {
        for (c = this.rootElement.node.getElementsByTagName("shape"), e = 0, f = c.length; f > e; e++) c[e].coordsize = a + " " + b, 
        c[e].style.width = a + "px", c[e].style.height = b + "px";
        for (d = this.node.getElementsByTagName("group"), e = 0, f = d.length; f > e; e++) d[e].coordsize = a + " " + b, 
        d[e].style.width = a + "px", d[e].style.height = b + "px";
    }
}, jvm.VMLCanvasElement.prototype.applyTransformParams = function(a, b, c) {
    this.scale = a, this.transX = b, this.transY = c, this.rootElement.node.coordorigin = this.width - b - this.width / 100 + "," + (this.height - c - this.height / 100), 
    this.rootElement.node.coordsize = this.width / a + "," + this.height / a;
}, jvm.VMLShapeElement = function(a, b) {
    jvm.VMLShapeElement.parentClass.call(this, a, b), this.fillElement = new jvm.VMLElement("fill"), 
...
jvm.VMLShapeElement.prototype.applyAttr = function(a, b) {
    switch (a) {
      ...
      case "stroke":
        this.node.stroked = "none" === b ? !1 : !0, this.node.strokecolor = b;
        break;
      ...
      case "stroke-width":
        this.node.stroked = 0 === parseInt(b, 10) ? !1 : !0, this.node.strokeweight = b;
        break;
    ...
    jvm.VMLPathElement.parentClass.call(this, "shape", a, b), this.node.coordorigin = "0 0", 
    c.node.on = !0, c.node.matrix = "0.01,0,0,0.01,0,0", c.node.offset = "0,0", this.node.appendChild(c.node);
    ...
    return a = a.replace(/(-?\d+)e(-?\d+)/g, "0"), a.replace(/([MmLlHhVvCcSs])\s*((?:-?\d*(?:\.\d+)?\s*,?\s*)+)/g, function(a, f, g) {
        ...
        switch (f) {
          ...
          case "c":
            return b = d + g[g.length - 4], c = e + g[g.length - 3], d += g[g.length - 2], e += g[g.length - 1], 
            "v" + g.join(",");

          case "C":
            return b = g[g.length - 4], c = g[g.length - 3], d = g[g.length - 2], e = g[g.length - 1], 
            "c" + g.join(",");

          case "s":
            return g.unshift(e - c), g.unshift(d - b), b = d + g[g.length - 4], c = e + g[g.length - 3], 
            d += g[g.length - 2], e += g[g.length - 1], "v" + g.join(",");

          case "S":
            return g.unshift(e + e - c), g.unshift(d + d - b), b = g[g.length - 4], c = g[g.length - 3], 
            d = g[g.length - 2], e = g[g.length - 1], "c" + g.join(",");
        }
        return "";
    }).replace(/z/g, "e");
    ...
    switch (a) {
      case "r":
        this.node.style.width = 2 * b + "px", this.node.style.height = 2 * b + "px", this.applyAttr("cx", this.get("cx") || 0), 
    ...
    return this.mode = window.SVGAngle ? "svg" : "vml", this.impl = "svg" == this.mode ? new jvm.SVGCanvasElement(a, b, c) : new jvm.VMLCanvasElement(a, b, c), 
    this.impl;
    ...
    this.scale = [], b = b || "linear", a && this.setScale(a), b && this.setNormalizeFunction(b), 
    c && this.setMin(c), d && this.setMax(d);
    ...
    setNormalizeFunction: function(a) {
        "polynomial" === a ? this.normalize = function(a) {
            return Math.pow(a, .2);
        } : "linear" === a ? delete this.normalize : this.normalize = a, this.setMin(this.clearMinValue), 
        this.setMax(this.clearMaxValue);
    },
    getValue: function(a) {
        var b, c, d = [], e = 0, f = 0;
        for ("function" == typeof this.normalize && (a = this.normalize(a)), f = 0; f < this.scale.length - 1; f++) b = this.vectorLength(this.vectorSubtract(this.scale[f + 1], this.scale[f])), 
        d.push(b), e += b;
    ...
    var c;
    a = a || {}, a.attribute = a.attribute || "fill", this.elements = b, this.params = a, 
    a.attributes && this.setAttributes(a.attributes), jvm.$.isArray(a.scale) ? (c = "fill" === a.attribute || "stroke" === a.attribute ? jvm.ColorScale : jvm.NumericScale, 
    this.scale = new c(a.scale, a.normalizeFunction, a.min, a.max)) : this.scale = a.scale ? new jvm.OrdinalScale(a.scale) : new jvm.SimpleScale(a.scale), 
    this.values = a.values || {}, this.setValues(this.values);
}, jvm.DataSeries.prototype = {
    setAttributes: function(a, b) {
        var c, d = a;
        if ("string" == typeof a) this.elements[a] && this.elements[a].setStyle(this.params.attribute, b); else for (c in d) this.elements[c] && this.elements[c].element.setStyle(this.params.attribute, d[c]);
    },
    setValues: function(a) {
        var b, c, d = Number.MIN_VALUE, e = Number.MAX_VALUE, f = {};
        if (this.scale instanceof jvm.OrdinalScale || this.scale instanceof jvm.SimpleScale) for (c in a) f[c] = a[c] ? this.scale.getValue(a[c]) : this.elements[c].element.style.initial[this.params.attribute]; else {
            if (!this.params.min || !this.params.max) {
                for (c in a) b = parseFloat(a[c]), b > d && (d = a[c]), e > b && (e = b);
                this.params.min || this.scale.setMin(e), this.params.max || this.scale.setMax(d), 
                this.params.min = e, this.params.max = d;
            }
            for (c in a) b = parseFloat(a[c]), f[c] = isNaN(b) ? this.elements[c].element.style.initial[this.params.attribute] : this.scale.getValue(b);
        }
    ...
    aea: function(a, b, c) {
        var d = 0, e = c * this.radDeg, f = 29.5 * this.radDeg, g = 45.5 * this.radDeg, h = a * this.radDeg, i = b * this.radDeg, j = (Math.sin(f) + Math.sin(g)) / 2, k = Math.cos(f) * Math.cos(f) + 2 * j * Math.sin(f), l = j * (i - e), m = Math.sqrt(k - 2 * j * Math.sin(h)) / j, n = Math.sqrt(k - 2 * j * Math.sin(d)) / j;
        return {
    ...
    aea_inv: function(a, b, c) {
        var d = a / this.radius, e = b / this.radius, f = 0, g = c * this.radDeg, h = 29.5 * this.radDeg, i = 45.5 * this.radDeg, j = (Math.sin(h) + Math.sin(i)) / 2, k = Math.cos(h) * Math.cos(h) + 2 * j * Math.sin(h), l = Math.sqrt(k - 2 * j * Math.sin(f)) / j, m = Math.sqrt(d * d + (l - e) * (l - e)), n = Math.atan(d / (l - e));
        return {
    ...
    lcc: function(a, b, c) {
        var d = 0, e = c * this.radDeg, f = b * this.radDeg, g = 33 * this.radDeg, h = 45 * this.radDeg, i = a * this.radDeg, j = Math.log(Math.cos(g) * (1 / Math.cos(h))) / Math.log(Math.tan(Math.PI / 4 + h / 2) * (1 / Math.tan(Math.PI / 4 + g / 2))), k = Math.cos(g) * Math.pow(Math.tan(Math.PI / 4 + g / 2), j) / j, l = k * Math.pow(1 / Math.tan(Math.PI / 4 + i / 2), j), m = k * Math.pow(1 / Math.tan(Math.PI / 4 + d / 2), j);
        return {
    ...
    var b, c = this;
    if (this.params = jvm.$.extend(!0, {}, jvm.WorldMap.defaultParams, a), !jvm.WorldMap.maps[this.params.map]) throw new Error("Attempt to use map which was not loaded: " + this.params.map);
    ...
    for (b in jvm.WorldMap.apiEvents) this.params[b] && this.container.bind(jvm.WorldMap.apiEvents[b] + ".jvectormap", this.params[b]);
    ...
    resize: function() {
        ...
        this.scale *= this.baseScale / a, this.transX *= this.baseScale / a, this.transY *= this.baseScale / a;
    },
    setSize: function() {
    ...
    applyTransform: function() {
        ...
        c = (this.width - this.defaultWidth * this.scale) / this.scale), this.defaultHeight * this.scale <= this.height ? (b = (this.height - this.defaultHeight * this.scale) / (2 * this.scale), 
        d = (this.height - this.defaultHeight * this.scale) / (2 * this.scale)) : (b = 0, 
        d = (this.height - this.defaultHeight * this.scale) / this.scale), this.transY > b ? this.transY = b : this.transY < d && (this.transY = d), 
        this.transX > a ? this.transX = a : this.transX < c && (this.transX = c), this.canvas.applyTransformParams(this.scale, this.transX, this.transY), 
    ...
    bindContainerEvents: function() {
        ...
        this.container.mousemove(function(e) {
            return c && (d.transX -= (a - e.pageX) / d.scale, d.transY -= (b - e.pageY) / d.scale, 
            d.applyTransform(), a = e.pageX, b = e.pageY), !1;
            ...
            d.label.hide(), d.setScale(d.scale * i, g, h), a.preventDefault();
        });
    },
    bindContainerTouchEvents: function() {
        var a, b, c, d, e, f, g, h = this, i = function(i) {
            var j, k, l, m, n = i.originalEvent.touches;
            "touchstart" == i.type && (g = 0), 1 == n.length ? (1 == g && (l = h.transX, m = h.transY, 
            h.transX -= (c - n[0].pageX) / h.scale, h.transY -= (d - n[0].pageY) / h.scale, 
            h.applyTransform(), h.label.hide(), (l != h.transX || m != h.transY) && i.preventDefault()), 
            c = n[0].pageX, d = n[0].pageY) : 2 == n.length && (2 == g ? (k = Math.sqrt(Math.pow(n[0].pageX - n[1].pageX, 2) + Math.pow(n[0].pageY - n[1].pageY, 2)) / b, 
            h.setScale(a * k, e, f), h.label.hide(), i.preventDefault()) : (j = jvm.$(h.container).offset(), 
            e = n[0].pageX > n[1].pageX ? n[1].pageX + (n[0].pageX - n[1].pageX) / 2 : n[0].pageX + (n[1].pageX - n[0].pageX) / 2, 
            f = n[0].pageY > n[1].pageY ? n[1].pageY + (n[0].pageY - n[1].pageY) / 2 : n[0].pageY + (n[1].pageY - n[0].pageY) / 2, 
            e -= j.left, f -= j.top, a = h.scale, b = Math.sqrt(Math.pow(n[0].pageX - n[1].pageX, 2) + Math.pow(n[0].pageY - n[1].pageY, 2)))), 
            g = n.length;
        };
    ...
    bindElementEvents: function() {
        ...
        this.container.mousemove(function() {
            ...
            var c = jvm.$(this).attr("class").baseVal ? jvm.$(this).attr("class").baseVal : jvm.$(this).attr("class"), d = -1 === c.indexOf("jvectormap-region") ? "marker" : "region", e = jvm.$(this).attr("region" == d ? "data-code" : "data-index"), f = "region" == d ? b.regions[e].element : b.markers[e].element, g = "region" == d ? b.mapData.paths[e].name : b.markers[e].config.name || "", h = jvm.$.Event(d + "LabelShow.jvectormap"), i = jvm.$.Event(d + "Over.jvectormap");
            "mouseover" == a.type ? (b.container.trigger(i, [ e ]), i.isDefaultPrevented() || f.setHovered(!0), 
            b.label.text(g), b.container.trigger(h, [ b.label, e ]), h.isDefaultPrevented() || (b.label.show(), 
            b.labelWidth = b.label.width(), b.labelHeight = b.label.height())) : (f.setHovered(!1), 
            b.label.hide(), b.container.trigger(d + "Out.jvectormap", [ e ]));
        }), this.container.delegate("[class~='jvectormap-element']", "mousedown", function() {
            a = !1;
        }), this.container.delegate("[class~='jvectormap-element']", "mouseup", function() {
            var c = jvm.$(this).attr("class").baseVal ? jvm.$(this).attr("class").baseVal : jvm.$(this).attr("class"), d = -1 === c.indexOf("jvectormap-region") ? "marker" : "region", e = jvm.$(this).attr("region" == d ? "data-code" : "data-index"), f = jvm.$.Event(d + "Click.jvectormap"), g = "region" == d ? b.regions[e].element : b.markers[e].element;
            a || (b.container.trigger(f, [ e ]), ("region" === d && b.params.regionsSelectable || "marker" === d && b.params.markersSelectable) && (f.isDefaultPrevented() || (b.params[d + "sSelectableOne"] && b.clearSelected(d + "s"), 
    ...
    createLabel: function() {
        ...
        this.container.mousemove(function(b) {
            ...
            5 > c && (c = b.pageX + 15), 5 > d && (d = b.pageY + 15), a.label.is(":visible") && a.label.css({
                left: c,
                top: d
            });
        });
    ...
    setScale: function(a, b, c, d) {
        ...
        "undefined" != typeof b && "undefined" != typeof c && (e = a / this.scale, d ? (this.transX = b + this.defaultWidth * (this.width / (this.defaultWidth * a)) / 2, 
        this.transY = c + this.defaultHeight * (this.height / (this.defaultHeight * a)) / 2) : (this.transX -= (e - 1) / a * b, 
        this.transY -= (e - 1) / a * c)), this.scale = a, this.applyTransform(), this.container.trigger(f, [ a / this.baseScale ]);
    },
    setFocus: function(a, b, c) {
        var d, e, f, g, h;
        if (jvm.$.isArray(a) || this.regions[a]) {
            for (g = jvm.$.isArray(a) ? a : [ a ], h = 0; h < g.length; h++) this.regions[g[h]] && (e = this.regions[g[h]].element.getBBox(), 
            e && ("undefined" == typeof d ? d = e : (f = {
                x: Math.min(d.x, e.x),
                y: Math.min(d.y, e.y),
        ...
        } else a *= this.baseScale, this.setScale(a, -b * this.defaultWidth, -c * this.defaultHeight, !0);
    },
    ...
    setSelected: function(a, b) {
        var c;
        if ("object" != typeof b && (b = [ b ]), jvm.$.isArray(b)) for (c = 0; c < b.length; c++) this[a][b[c]].element.setSelected(!0); else for (c in b) this[a][c].element.setSelected(!!b[c]);
    },
    ...
    createRegions: function() {
        ...
        for (a in this.mapData.paths) b = this.canvas.addPath({
            ...
            "data-code": a
        }, jvm.$.extend(!0, {}, this.params.regionStyle)), jvm.$(b.node).bind("selected", function(a, b) {
            c.container.trigger("regionSelected.jvectormap", [ jvm.$(this).attr("data-code"), b, c.getSelectedRegions() ]);
        }), b.addClass("jvectormap-region jvectormap-element"), this.regions[a] = {
            element: b,
    ...
    createMarkers: function(a) {
        ...
        if (this.markersGroup = this.markersGroup || this.canvas.addGroup(), jvm.$.isArray(a)) for (f = a.slice(), 
        a = {}, b = 0; b < f.length; b++) a[b] = f[b];
        for (b in a) e = a[b] instanceof Array ? {
            latLng: a[b]
        } : a[b], d = this.getMarkerPosition(e), d !== !1 && (c = this.canvas.addCircle({
            "data-index": b,
            cx: d.x,
            cy: d.y
        }, jvm.$.extend(!0, {}, this.params.markerStyle, {
            initial: e.style || {}
        }), this.markersGroup), c.addClass("jvectormap-marker jvectormap-element"), jvm.$(c.node).bind("selected", function(a, b) {
    ...
    repositionMarkers: function() {
        var a, b;
        for (a in this.markers) b = this.getMarkerPosition(this.markers[a].config), b !== !1 && this.markers[a].element.setStyle({
            cx: b.x,
            cy: b.y
        });
    },
    ...
    addMarker: function(a, b, c) {
        var d, e, f = {}, g = [], c = c || [];
        for (f[a] = b, e = 0; e < c.length; e++) d = {}, d[a] = c[e], g.push(d);
        this.addMarkers(f, g);
    },
    ...
    latLngToPoint: function(a, b) {
        {
            var c, d, e, f = jvm.WorldMap.maps[this.params.map].projection, g = f.centralMeridian;
            this.width - 2 * this.baseTransX * this.baseScale, this.height - 2 * this.baseTransY * this.baseScale, 
            this.scale / this.baseScale;
        }
        return -180 + g > b && (b += 360), c = jvm.Proj[f.type](a, b, g), d = this.getInsetForPoint(c.x, c.y), 
        d ? (e = d.bbox, c.x = (c.x - e[0].x) / (e[1].x - e[0].x) * d.width * this.scale, 
        c.y = (c.y - e[0].y) / (e[1].y - e[0].y) * d.height * this.scale, {
            x: c.x + this.transX * this.scale + d.left * this.scale,
            y: c.y + this.transY * this.scale + d.top * this.scale
        }) : !1;
    },
    pointToLatLng: function(a, b) {
        var c, d, e, f, g, h = jvm.WorldMap.maps[this.params.map].projection, i = h.centralMeridian, j = jvm.WorldMap.maps[this.params.map].insets;
        for (c = 0; c < j.length; c++) if (d = j[c], e = d.bbox, f = a - (this.transX * this.scale + d.left * this.scale), 
        g = b - (this.transY * this.scale + d.top * this.scale), f = f / (d.width * this.scale) * (e[1].x - e[0].x) + e[0].x, 
        g = g / (d.height * this.scale) * (e[1].y - e[0].y) + e[0].y, f > e[0].x && f < e[1].x && g > e[0].y && g < e[1].y) return jvm.Proj[h.type + "_inv"](f, -g, i);
        return !1;
    },
    getInsetForPoint: function(a, b) {
        var c, d, e = jvm.WorldMap.maps[this.params.map].insets;
        for (c = 0; c < e.length; c++) if (d = e[c].bbox, a > d[0].x && a < d[1].x && b > d[0].y && b < d[1].y) return e[c];
    },
